...
import com.mytiki.capture.receipt.account.AccountTypeEnum
import com.mytiki.capture.receipt.email.Email
import com.mytiki.capture.receipt.receipt.Receipt
import com.mytiki.capture.receipt.retailer.Retailer
...
object CaptureReceipt {
    private var configuration: com.mytiki.capture.receipt.Configuration? = null
